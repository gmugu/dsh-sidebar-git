...
function GitPanel(props) {
  ...
  const [worktrees, setWorktrees] = (0, import_react2.useState)([]);
  const [selectedWorktree, setSelectedWorktree] = (0, import_react2.useState)();
  const [repoRoot, setRepoRoot] = (0, import_react2.useState)(void 0);
  const [loading, setLoading] = (0, import_react2.useState)(true);
  const [error, setError] = (0, import_react2.useState)(null);
  const [branchNames, setBranchNames] = (0, import_react2.useState)([]);
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              ...
              children: staged ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconTrashOutline16, {}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconPlusOutline16, {})
            }
          )
        ]
      },
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: import_changes.default.git, children: [
    ...
    loading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: import_changes.default.gitPlaceholder, children: t("loading") }),
    !loading && error !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: import_changes.default.gitError, children: error }),
    !loading && status !== null && !status.isRepo && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: import_changes.default.gitPlaceholder, children: t("notRepo") }),
    status !== null && status.isRepo && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: import_changes.default.gitSection, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: import_changes.default.gitSectionHeader, children: [
          ...
          unstagedEntries.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: import_changes.default.gitLink, disabled: busy, onClick: () => {
            void stageAll(false);
          }, children: t("stageAll") })
        ] }),
      ...
      commitError !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: import_changes.default.gitError, children: commitError }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: import_changes.default.gitSection, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        import_dsh_client_ui_primitives.Menu,
        {
          ...
          items: [
            ...
            ...fileMenu !== null && isWithinWorkspace(scope.cwd ?? "", resolveSidebarPath(repoRoot ?? selectedWorktree ?? scope.cwd, fileMenu.entry.path)) ? [{ id: "open", label: t("openEditor"), icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconCodeOutline16, { size: 14 }) }] : [],
            fileMenu?.staged === true ? { id: "stage", label: t("unstage"), icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconTrashOutline16, { size: 14 }) } : { id: "stage", label: t("stage"), icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconPlusOutline16, { size: 14 }) },
            ...fileMenu !== null && !isUntracked(fileMenu.entry) ? [{ id: "discard", label: t("discard"), icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconTrashOutline16, { size: 14 }), danger: true }] : [],
            { type: "separator", id: "sep1" },
            { id: "relative", label: t("copyRelative"), icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconCopyOutline16, { size: 14 }) },
            { id: "absolute", label: t("copyAbsolute"), icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconCopyOutline16, { size: 14 }) }
          ],
          onSelect: (id) => {
...
function DiffRows({ segments, lang, resolveFold }) {
  ...
  const renderSegment = (segment, segIndex) => {
    ...
    const expandable = (segment.rows !== void 0 || resolvedRows !== void 0 || resolveFold !== void 0) && segment.count >= MIN_FOLD;
    if (!expandable) {
...
var TEST_PATH = /(^|\/)(?:__tests__|tests?|specs?|fixtures?|mocks?|snapshots?)(?:\/|$)|\.(?:test|spec)\.[^/]+$/i;
var DOC_PATH = /(^|\/)(?:docs?|documentation)(?:\/|$)|(^|\/)(?:readme|changelog|contributing|license|authors|notice)(\.[^/]*)?$/i;
var GENERATED_PATH = /(^|\/)(?:dist|build|coverage|generated|vendor|node_modules)(?:\/|$)|(^|\/)(?:package-lock\.json|pnpm-lock\.yaml|yarn\.lock|bun\.lockb?|composer\.lock|cargo\.lock|poetry\.lock)$/i;
var SOURCE_PATH = /\.(?:js|jsx|mjs|cjs|ts|tsx|mts|cts|py|pyw|rb|php|java|kt|kts|scala|go|rs|swift|c|h|cc|cpp|cxx|hpp|hh|hxx|cs|fs|fsx|vb|dart|lua|r|ex|exs|erl|hrl|clj|cljs|cljc|groovy|sh|bash|zsh|fish|ps1|sql|vue|svelte|astro|html|htm|css|scss|sass|less)$/i;
function defaultExpandedFiles(files) {
  const expanded = /* @__PURE__ */ new Set();
  files.forEach((file, index) => {
    const path = displayPath(file.newPath === "/dev/null" ? file.oldPath : file.newPath);
    if (!file.binary && file.hunks.length > 0 && !TEST_PATH.test(path) && !DOC_PATH.test(path) && !GENERATED_PATH.test(path) && SOURCE_PATH.test(path)) {
      expanded.add(index);
    }
  });
  return expanded;
...
function DiffFiles({ diff, untrackedPath, untrackedContent, resolveFold }) {
  ...
  const [expandedFiles, setExpandedFiles] = (0, import_react4.useState)(() => defaultExpandedFiles(parsed.files));
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: import_diff2.default.fileBlock, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
        "button",
        {
          ...
          children: [
            expandable && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { "aria-hidden": "true", className: clsx_default(import_diff2.default.fileChevron, fileExpanded && import_diff2.default.fileChevronExpanded), children: "\u203A" }),
            ...
            expandable && (stats.added > 0 || stats.deleted > 0) && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: import_diff2.default.fileStats, children: [
      ...
      expandable && fileExpanded && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(DiffRows, { segments, lang: langOfPath(to), resolveFold: resolveFold !== void 0 ? (segment) => loadFold(file, segment) : void 0 })
...
function GitDiffPane({ target, scope, height, onHeightCommit, onClose }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: import_changes2.default.diffPane, style: { height: paneHeight }, children: [
    ...
    loading ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: import_changes2.default.paneBody, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: import_changes2.default.gitPlaceholder, children: t("loading") }) }) : error !== null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: import_changes2.default.paneBody, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: import_changes2.default.gitError, children: [
      ...
      diffText !== null && diffText !== "" && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        DiffFiles,
        {
          diff: diffText,
      ...
      diffText === "" && untracked === void 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: import_changes2.default.gitEmpty, children: t("diffEmpty") })
    ] })
  ] });
}

// src/client/resource-address.ts
...
function GitTabBody(props) {
  ...
  const [paneHeight, setPaneHeight] = (0, import_react6.useState)(300);
  const openFile = (path) => {
